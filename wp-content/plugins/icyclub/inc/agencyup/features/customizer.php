	...
	$wp_customize->add_section( 'slider_section' , array(
		...
		$wp_customize->add_setting( 'home_page_slider_enabled',
		   array(
			  'default' => 1,
			  'transport' => 'refresh',
			  'sanitize_callback' => 'icycp_agencyup_switch_sanitization'
		   )
		);
...
/* Services section */
	...
	$wp_customize->add_setting( 'contact_info_section_show',
		   array(
			  'default' => 1,
			  'transport' => 'refresh',
			  'sanitize_callback' => 'icycp_consultup_switch_sanitization'
		   )
		);
...
if ( ! function_exists( 'icycp_consultup_switch_sanitization' ) ) {
		function icycp_consultup_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
