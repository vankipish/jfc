		...
		<?php } ?>
			<div class="row">
			  <div class="col-sm-4 col-md-4 swing animated service-one">
			  	<div class="bs-sevice two text-center shd" style="background-image: url('<?php echo $service_image_1; ?>');">
              ...
              <div class="col-sm-4 col-md-4 swing animated service-two">
			  	<div class="bs-sevice two text-center shd" style="background-image: url('<?php echo $service_image_2; ?>');">
                 <div class="bs-sevice-inner">
        ...
        <!--portfolio-->
          <!--item-->
            ...
            <div class="col-md-3 project-one">
              <!--portfolio-->
               <div class="bs-portfolio-block" style="background-image: url(<?php echo $project_image_one;?>);">
		  ...
		  <div class="col-md-3 project-two">
              <!--portfolio-->
               <div class="bs-portfolio-block" style="background-image: url(<?php echo $project_image_two;?>);">
                  <div class="inner-content">
                    <div class="text clearfix">
                     <div class="bottom_text">
			...
			<div class="col-md-3 project-three">
              <!--portfolio-->
               <div class="bs-portfolio-block" style="background-image: url(<?php echo $project_image_three;?>);">
                  <div class="inner-content">
                    <div class="text clearfix">
                     <div class="bottom_text">
            ...
            <div class="col-md-3 project-four">
              <!--portfolio-->
               <div class="bs-portfolio-block" style="background-image: url(<?php echo $project_image_four;?>);">
                  <div class="inner-content">
                    <div class="text clearfix">
                     <div class="bottom_text">
...
function icycp_consultup_news() {
 ...
 $news_section_show = get_theme_mod('news_section_show','on');
if($news_section_show !='off'){
