		...
		<?php } ?>
			<div class="row">
			  ...
			  <div class="col-sm-4 col-md-4 swing animated service-two">
                <div class="consultup-service three text-left">
                  <div class="consultup-service-inner">
				    <?php  $service_two_icon = get_theme_mod('service_two_icon','fa fa-newspaper-o'); ?>
            ...
            <div class="consultup-blog-post-box"> 
              ...
              <article class="small">
                <h1 class="title"> <a href="<?php echo esc_url(get_permalink()); ?>" title="<?php the_title_attribute(); ?>"><?php echo get_the_title() ?></a> </h1>
                  <div class="consultup-blog-meta"><span class="consultup-blog-date"><i class="fa fa-clock-o"></i><a href="<?php echo esc_url(get_month_link(get_post_time('Y'),get_post_time('m'))); ?>">
