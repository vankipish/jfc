...
function travel_tourism_admin_theme_style() {
   wp_enqueue_style( 'travel-tourism-font', travel_tourism_admin_font_url(), array() );
...
// Theme Font URL
function travel_tourism_admin_font_url() {
	$font_url = '';
	$font_family = array();
    ...
    <div class="tab-sec">
			...
			<?php if(!class_exists('Ibtana_Visual_Editor_Menu_Class')){ 
				...
				<div class="travel-tourism-recommended-plugins">
				    <div class="travel-tourism-action-list">
				    	<div class="travel-tourism-activation-note">
							<?php esc_html_e('Your filesystem not have write permission, please give writable access to your filesystem','travel-tourism'); ?>
						</div>
					...
					<div class="info-link">
			  		...
			  		<div class="link-customizer">
						...
						<div class="first-row">
							<div class="row-box">
								<div class="row-box1">
									<span class="dashicons dashicons-format-image"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[control]=custom_logo') ); ?>" target="_blank"><?php esc_html_e('Upload your logo','travel-tourism'); ?></a>
								</div>
								<div class="row-box2">
									<span class="dashicons dashicons-images-alt"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=travel_tourism_slidersettings') ); ?>" target="_blank"><?php esc_html_e('Slider Settings','travel-tourism'); ?></a>
								</div>
							</div>
							<div class="row-box">
								<div class="row-box1">
							...
							<div class="row-box">
								<div class="row-box1">
									<span class="dashicons dashicons-editor-aligncenter"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[panel]=nav_menus') ); ?>" target="_blank"><?php esc_html_e('Menus','travel-tourism'); ?></a>
								</div>
								<div class="row-box2">
							...
							<div class="row-box">
								<div class="row-box1">
									<span class="dashicons dashicons-images-alt"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=travel_tourism_post_settings') ); ?>" target="_blank"><?php esc_html_e('Post settings','travel-tourism'); ?></a>
								</div>
								 <div class="row-box2">
									<span class="dashicons dashicons-cart"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=travel_tourism_woocommerce_section') ); ?>" target="_blank"><?php esc_html_e('WooCommerce Layout','travel-tourism'); ?></a>
								</div> 
							</div>
							
							<div class="row-box">
								<div class="row-box1">
									<span class="dashicons dashicons-welcome-write-blog"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=travel_tourism_left_right') ); ?>" target="_blank"><?php esc_html_e('General Settings','travel-tourism'); ?></a>
								</div>
								<div class="row-box2">
									<span class="dashicons dashicons-align-center"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=travel_tourism_footer') ); ?>" target="_blank"><?php esc_html_e('Footer Text','travel-tourism'); ?></a>
								</div>
							</div>
						</div>
					</div>
		...
		<div id="gutenberg_editor" class="tabcontent">
			...
			<?php }else{ ?>
				...
				<hr class="h3hr">
				<div class="travel-tourism-pattern-page">
			    	<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Ibtana Settings','travel-tourism'); ?></a>
			    </div>
			<?php } ?>
		</div>
