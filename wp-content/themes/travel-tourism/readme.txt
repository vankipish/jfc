...
= 0.2 =
* Change WordPress versio in theme.
* Added condition on menus.
* Updated POT file.

= 0.2.1 =
* Resolved Header image issue.
* Added escaping in icon-picker.php file L18.
* Changed license in readme.txt file.
...
Travel Tourism WordPress Theme, Copyright 2019 VWThemes
Travel Tourism is distributed under the terms of the GNU GPL.
...
Header Image,
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/1200073

* All the icons taken from genericons licensed under GPL License.
http://genericons.com/

== Theme Documentation ==
Documentation : https://www.vwthemesdemo.com/docs/free-travel-tourism/