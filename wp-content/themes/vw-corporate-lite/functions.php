...
function vw_corporate_lite_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Shop Page Sidebar', 'vw-corporate-lite' ),
		'description'   => __( 'Appears on shop page', 'vw-corporate-lite' ),
	...
	register_sidebar( array(
		'name'          => __( 'Single Product Sidebar', 'vw-corporate-lite' ),
		'description'   => __( 'Appears on shop page', 'vw-corporate-lite' ),
...
function vw_corporate_lite_scripts() {
	...
	wp_enqueue_style('vw-corporate-lite-block-style', get_theme_file_uri('/css/blocks.css') );
	wp_enqueue_style( 'vw-corporate-lite-block-patterns-style-frontend', get_theme_file_uri('/inc/block-patterns/css/block-frontend.css') );
	...
	wp_add_inline_style( 'vw-corporate-lite-basic-style',$vw_corporate_lite_custom_css );
	...
	wp_enqueue_script('vw-corporate-lite-customscripts', esc_url(get_template_directory_uri()).'/js/custom.js', array('jquery'));
 ...
 */
function vw_corporate_lite_block_editor_styles() {
	wp_enqueue_style( 'vw-corporate-lite-font', vw_corporate_lite_font_url(), array() );
    wp_enqueue_style( 'vw-corporate-lite-block-patterns-style-editor', get_theme_file_uri( '/inc/block-patterns/css/block-editor.css' ), false, '1.0', 'all' );
    wp_enqueue_style( 'bootstrap-style', esc_url(get_template_directory_uri()).'/css/bootstrap.css' );
    wp_enqueue_style('font-awesome', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'enqueue_block_editor_assets', 'vw_corporate_lite_block_editor_styles' );

define('VW_CORPORATE_LITE_FREE_THEME_DOC',__('https://www.vwthemesdemo.com/docs/free-vw-corporate-lite/', 'vw-corporate-lite'));
define('VW_CORPORATE_LITE_REVIEW',__('https://wordpress.org/support/theme/vw-corporate-lite/reviews/', 'vw-corporate-lite'));
define('VW_CORPORATE_LITE_BUY_NOW',__('https://www.vwthemes.com/themes/corporate-wordpress-theme/', 'vw-corporate-lite'));
define('VW_CORPORATE_LITE_LIVE_DEMO',__('https://www.vwthemes.net/vw-corporate-theme/', 'vw-corporate-lite'));
define('VW_CORPORATE_LITE_PRO_DOC',__('https://www.vwthemesdemo.com/docs/vw-corporate-pro/', 'vw-corporate-lite'));
define('VW_CORPORATE_LITE_FAQ',__('https://www.vwthemes.com/faqs/', 'vw-corporate-lite'));
define('VW_CORPORATE_LITE_CHILD_THEME',__('https://developer.wordpress.org/themes/advanced-topics/child-themes/','vw-corporate-lite'));
define('VW_CORPORATE_LITE_CONTACT',__('https://www.vwthemes.com/contact/', 'vw-corporate-lite'));
define('VW_CORPORATE_LITE_SUPPORT',__('https://wordpress.org/support/theme/vw-corporate-lite/', 'vw-corporate-lite'));
define('VW_CORPORATE_LITE_CREDIT',__('https://www.vwthemes.com/themes/wp-corporate-wordpress-theme/', 'vw-corporate-lite'));

if (!function_exists('vw_corporate_lite_credit')) {
	function vw_corporate_lite_credit() {
		echo "<a href=".esc_url(VW_CORPORATE_LITE_CREDIT).">".esc_html__('Corporate WordPress Theme', 'vw-corporate-lite')."</a>";
	}
}
...
function vw_corporate_lite_sanitize_float( $input ) {
	return filter_var($input, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
}

function vw_corporate_lite_sanitize_number_range( $number, $setting ) {
...
function vw_corporate_lite_sanitize_email( $email, $setting ) {
...
function vw_corporate_lite_sanitize_phone_number( $phone ) {
...
add_filter('loop_shop_columns', 'vw_corporate_lite_loop_columns');
	...
	function vw_corporate_lite_loop_columns() {
		return get_theme_mod( 'vw_corporate_lite_products_per_row', '3' ); 
		// 3 products per row
	}
}

//Change number of products that are displayed per page (shop page)
add_filter( 'loop_shop_per_page', 'vw_corporate_lite_products_per_page' );
function vw_corporate_lite_products_per_page( $cols ) {
  	return  get_theme_mod( 'vw_corporate_lite_products_per_page',9);
}
